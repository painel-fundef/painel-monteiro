...
let view='geral';
let filters={trib:'',setor:'',filial:'',grau:'',env:'',busca:'',relator:'',piso:'',vara:'',turma:'',tipo:''};
...
const COLS_GERAL=[['parte','Parte / Processo'],['trib','Trib.'],['grau','Grau','hide-sm'],['setor','Setor'],['materia','Matéria','hide-sm'],['envolvimento','Envolvimento','hide-sm'],['filial','Filial','hide-sm'],['valEnv','Valor env.','vcell']];
...
function render(){
  ...
  if(view==='geral'){
    ...
    bars('c-env',null,rows,'envolvimento','env');tipoAcao(rows);bars('c-grau',null,rows,'grau','grau');topVal(rows);agenda(rows);contRisk(rows);
...
(function(){
  ...
  document.getElementById('clear').onclick=()=>{filters={trib:'',setor:'',filial:'',grau:'',env:'',busca:'',relator:'',piso:'',vara:'',turma:'',tipo:''};document.querySelectorAll('select').forEach(s=>s.value='');document.getElementById('f-busca').value='';render();};
